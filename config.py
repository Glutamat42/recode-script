...
class Config:
    def __init__(self):
        ...
        self.audio_multichannel_vbr_level = 3  # used for streams witht more than 2 channels. VBR level for libfdk_aac multi-channel (1-5, where 1=highest quality, 5=lowest)
